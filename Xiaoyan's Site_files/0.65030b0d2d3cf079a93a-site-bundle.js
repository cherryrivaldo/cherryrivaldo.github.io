...
webpackJsonp([0],{346:function(){!function(t,e,n,o){"use strict"
...
"pushState"in history?history.pushState("",t.title,e.location.pathname+e.location.search+"#"+a):e.location.hash=a}},"beforeClose.fb":function(n,o){var i=s(o),r=o&&o.opts.origHash?o.opts.origHash:""
i&&""!==i&&("pushState"in history?history.pushState("",t.title,e.location.pathname+e.location.search+r):e.location.hash=r)
a=null}})
